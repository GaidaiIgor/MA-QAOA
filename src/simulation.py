...
def run_ma_qaoa_simulation(angles: ndarray, p: int, all_cuv_vals: ndarray, edge_inds: list[int] = None) -> float:
    """
    Runs MA-QAOA by direct simulation of quantum evolution.
